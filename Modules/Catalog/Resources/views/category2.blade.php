            ...
            <div class="box-body form-horizontal parent-category">
                ...
                <form method="post" action="{{route('catalog.category.proses')}}" id="fileinfo">
                    ...
                    <div id="formerror-f_deskripsikategori" class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control f_deskripsikategori"  name="f_deskripsikategori" placeholder="Deskripsi.." required></textarea>
                    ...
                    <div class="form-group">
                        <div class="col-sm-6 col-md-offset-3">
                            <button class="btn btn-primary btn-edit">Edit Simpan</button>
    ...
    $('#jstree')
        .on("changed.jstree", function (e, data) {
            if(data.selected.length) {               
                ...
                $(".f_parentname").html("Rubah Kategori - " + data.instance.get_node(data.selected[0]).text);
