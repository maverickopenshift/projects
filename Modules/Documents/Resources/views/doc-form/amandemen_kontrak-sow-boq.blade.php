        ...
        @foreach ($f_judul as $key => $value)
          <div class="form-horizontal perubahan" style="border: 1px solid #d2d6de;padding: 10px;position: relative;margin-top: 15px;margin-bottom: 33px;">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <select class="form-control f_judul" name="f_judul[]" onchange="freeText()" autocomplete="off">
                  <option value="" {!!Helper::prop_selected($f_judul[$key],"")!!} >Pilih</option>
                  <option value="Harga" {!!Helper::prop_selected($f_judul[$key],"Harga")!!} >Harga</option>
                  <option value="Jangka Waktu" {!!Helper::prop_selected($f_judul[$key],"Jangka Waktu")!!} >Jangka Waktu</option>
                  <option value="Lainnya" {!!Helper::prop_selected($f_judul[$key],"Lainnya")!!} >Lainnya</option>
                </select>
              </div>
            </div>
            ...
            <div class="form-group show_lainnya">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control f_isi" name="f_isi[]" cols="4" rows="4">{{$f_isi[$key]}}</textarea>
                </div>
            </div>
            ...
            <div class="form-group show_harga">
                ...
                <div class="col-sm-3">
                  <input type="text" name="f_harga[]" value="{{$f_harga[$key]}}" class="form-control f_harga input-rupiah">
                </div>
            </div>
