  ...
  <div class="col-sm-10">
    @if(count(old('legal_dokumen',Helper::prop_exists($data,'legal_dokumen','array')))>0)
      @php
        $i=1;
      @endphp
      @foreach (old('legal_dokumen',Helper::prop_exists($data,'legal_dokumen','array')) as $k => $d)
        <div class="row row-legal-dokumen bottom15">
            <div class="col-sm-4">
                ...
                @if ($errors->has('legal_dokumen.'.($k).'.name'))
                    <span class="help-block">
                        <strong>{{ $errors->first('legal_dokumen.'.($k).'.
                        name') }}</strong>
                    </span>
                @endif
            </div>
            ...
            <div class="col-sm-4 attr-btn">
                @if(count(old('legal_dokumen',Helper::prop_exists($data,'legal_dokumen','array')))>1)
                ...
                @endif
                @if(count(old('legal_dokumen',Helper::prop_exists($data,'legal_dokumen','array')))==$i )
    ...
    <div class="col-sm-12">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-7">
          ...
          @php
            $legal_dokumen_old = Helper::old_prop_each($data,'file_old_ld');
            $legal_dokumen = Helper::old_prop_each($data,'file_old_ld');
            $legal_dokumen_nama = Helper::old_prop_each($data,'legal_dokumen_nama');
