    ...
    <div class="box-body">
      <div class="form-horizontal">
          <div class="form-group {{ $errors->has('nm_direktur_utama') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-10">
                <input type="text" name="nm_direktur_utama" value="{{old('nm_direktur_utama',Helper::prop_exists($data,'nm_direktur_utama'))}}" class="form-control" placeholder="" autocomplete="off">
          ...
          <div class="form-group {{ $errors->has('nm_komisaris_utama') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-10">
                <input type="text" name="nm_komisaris_utama" value="{{old('nm_komisaris_utama',Helper::prop_exists($data,'nm_komisaris_utama'))}}" class="form-control" placeholder="" autocomplete="off">
          ...
          <div class="form-group {{ $errors->has('jml_peg_domestik') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-10">
                <input type="text" name="jml_peg_domestik" value="{{old('jml_peg_domestik',Helper::prop_exists($data,'jml_peg_domestik'))}}" class="form-control" placeholder="" autocomplete="off">
          ...
          <div class="form-group {{ $errors->has('jml_peg_asing') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-10">
                <input type="text" name="jml_peg_asing" value="{{old('jml_peg_asing',Helper::prop_exists($data,'jml_peg_asing'))}}" class="form-control" placeholder="" autocomplete="off">
