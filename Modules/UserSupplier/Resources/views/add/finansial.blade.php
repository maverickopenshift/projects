          ...
          <div class="form-group {{ $errors->has('asset') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-10">
              <div class="input-group">
                ...
                <input type="text" name="asset" value="{{old('asset',Helper::prop_exists($data,'asset'))}}" class="form-control" placeholder="Masukan Asset Perusahaan" aria-describedby="asset" autocomplete="off">
              </div>
              @if ($errors->has('asset'))
